...
export function downloadCard(name: string, rarity: string) {
  ...
  if (!ctx) return;
  ctx.fillStyle = '#18271f';
  ctx.fillRect(0, 0, 1080, 1920);
  ctx.strokeStyle = '#8b9b82';
  ctx.lineWidth = 2;
  for (let i = 0; i < 4; i++) {
    ctx.beginPath();
  ...
  ctx.font = '28px Arial';
  ctx.fillText('ASTRAL KIN × LOOPBOX', 540, 210);
  ...
  ctx.font = '26px Arial';
  ctx.fillText(rarity + ' / THE FIRST CONSTELLATION', 540, 1360);
  ctx.font = '34px Arial';
  ctx.fillText('A little mystery. A connection found.', 540, 1580);
  ctx.font = '22px Arial';
  ctx.fillStyle = '#a9b5a7';
  ctx.fillText('DIGITAL COLLECTIBLE · DEMO ACHIEVEMENT', 540, 1770);
